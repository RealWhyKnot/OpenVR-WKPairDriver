...
void IkFallback::SetOffset(BodyRole role,
                           const double rel_pos[3],
                           const vr::HmdQuaternion_t& rel_rot)
{
...
{
    for (auto& o : offsets_) o = TrackerOffset{};
}
...
bool IkFallback::Solve(BodyRole role,
                       const vr::DriverPose_t& hmd_pose,
