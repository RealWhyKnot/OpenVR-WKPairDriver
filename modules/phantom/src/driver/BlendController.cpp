...
double BlendController::QuatDot(const vr::HmdQuaternion_t& a,
...
void Slerp(const vr::HmdQuaternion_t& a, const vr::HmdQuaternion_t& b,
           double alpha, vr::HmdQuaternion_t& out)
{
    ...
    if (n > 1e-12) { out.w/=n; out.x/=n; out.y/=n; out.z/=n; }
    else           { out.w = 1.0; out.x = out.y = out.z = 0.0; }
}

} // namespace

void BlendController::Lerp(
